...
s = Classifier.fit(X_train,y_train)
accu = s.score(X_test,y_test)
print("Accuracy of SVM: ",accu)

##Logistic Regression
Classifier = LogisticRegression(solver = 'liblinear')
log = Classifier.fit(X_train, y_train)
accur = log.score(X_test, y_test)
...
accur = dec.score(X_test, y_test)
print("Accuracy of Decision Tree Classifier: ",accur)

##Random Forest Classification Algorithm
Classifier = RandomForestClassifier(criterion = 'entropy')
ran = Classifier.fit(X_train, y_train)
accur = ran.score(X_test, y_test)
...
pickle.dump(ran, open('ran.pkl', "wb"))
